...
from service.network_service import get_network_service
...
async def get_node_neighbors(
    ...
    return await network_service.get_node_neighbors(node_id, limit)
...
async def search_seed_node(
    ...
    return await network_service.search_seed_nodes(query)